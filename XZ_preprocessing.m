...
%% Toolboxes required:
% CNMFE, NormCorre, MiniscopeAnalysis(msrun)    these can be found in
% 1p_preprocessing/Toolboxes
% Optional functions:
% codec conversion, flv1 to gray, use convert_msCam1({dir})
% convert RGB avi to Gray avi, use aviRGBtoGray(dir, saving_directory, read_prefix, write_prefix)
